...
print("Lista de 100k: ")
ini_bubble_100K = time.time()
bubble_sort(lista_ordenada100k)
fim_bubble_100K = time.time()
ini_bubble2_100K = time.time()
bubble_sort(lista_inversa100k)
fim_bubble2_100K = time.time()
ini_bubble3_100K = time.time()
bubble_sort(lista_aleatoria100k)
fim_bubble3_100K = time.time()
print("Tempo bubble Sort: "+ str( fim_bubble_100K - ini_bubble_100K))
print("Tempo bubble Sort: "+ str( fim_bubble2_100K - ini_bubble2_100K))
print("Tempo bubble Sort: "+ str( fim_bubble3_100K - ini_bubble3_100K))